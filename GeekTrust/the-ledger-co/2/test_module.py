...
class testResult(unittest.TestCase):
    ...
    def testNoLumpSum(self):
        ...
        self.assertEqual(ledger.Result(Lines),expected,"testNoLumpSum failed")
    ...
    def testLumpSumPaidAtZerothInstallment(self):
        ...
        self.assertEqual(ledger.Result(Lines),expected,"testLumpSumPaidAtZerothInstallment failed")
    ...
    def testLumpSumPaidAtZerothAndNonZerothInstallment(self):
        ...
        self.assertEqual(ledger.Result(Lines),expected,"testLumpSumPaidAtZerothAndNonZerothInstallment failed")
    ...
    def testLumpSumPaidAtNonZerothInstallment(self):
        ...
        self.assertEqual(ledger.Result(Lines),expected,"testLumpSumPaidAtNonZerothInstallment failed")
